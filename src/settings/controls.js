...
import { BaseControl, Button, ButtonGroup, Dropdown, DropdownMenu, MenuGroup, MenuItem, PanelBody, PanelRow, RangeControl, SelectControl, ToggleControl, Toolbar, ToolbarButton, ToolbarGroup, Tooltip } from '@wordpress/components';
import { BlockControls, ColorPalette, InspectorControls, MediaUpload, __experimentalBlockAlignmentMatrixControl as BlockAlignmentMatrixControl } from '@wordpress/block-editor';
				        ...
				        controls={ [
				            {
				                ...
				                isActive: attributes.boxShadow === 'wp-block-popper__shadow-none' ? true : false,
				                onClick: () => setAttributes( { boxShadow: 'wp-block-popper__shadow-none' } ),
				            },
				            {
								label: __( 'Small', 'popper' ),
								title: 'Small',
				                icon: icons.boxShadowSmall,
				                isActive: attributes.boxShadow === 'wp-block-popper__shadow-sm' ? true : false,
				                onClick: () => setAttributes( { boxShadow: 'wp-block-popper__shadow-sm' } ),
				            },
				            {
								label: __( 'Medium', 'popper' ),
								title: 'Medium',
				                icon: icons.boxShadowMedium,
				                isActive: attributes.boxShadow === 'wp-block-popper__shadow-md' ? true : false,
				                onClick: () => setAttributes( { boxShadow: 'wp-block-popper__shadow-md' } ),
				            },
				            {
								label: __( 'Large', 'popper' ),
								title: 'Large',
				                icon: icons.boxShadowLarge,
				                isActive: attributes.boxShadow === 'wp-block-popper__shadow-lg' ? true : false,
				                onClick: () => setAttributes( { boxShadow: 'wp-block-popper__shadow-lg' } ),
				            },
				            {
								label: __( 'X-Large', 'popper' ),
								title: 'X-Large',
				                icon: icons.boxShadowXLarge,
				                isActive: attributes.boxShadow === 'wp-block-popper__shadow-xl' ? true : false,
				                onClick: () => setAttributes( { boxShadow: 'wp-block-popper__shadow-xl' } ),
				            }
				        ] }
				    />
				    <DropdownMenu
